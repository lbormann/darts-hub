...
namespace darts_hub.control
{
    ...
    public class ProfileManager
    {
        ...
        private void CreateDummyDownloadMaps()
        {
            ...
            dartsWledDownloadUrl = dartsWledDownloadMap.GetDownloadUrlByOs("b2.0.1.2");
            ...
            dartsPixelitDownloadUrl = dartsPixelitDownloadMap.GetDownloadUrlByOs("b2.0.1.2");
            ...
            dartsGifDownloadUrl = dartsGifDownloadMap.GetDownloadUrlByOs("b2.0.1.2");
