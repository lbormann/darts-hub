...
namespace darts_hub.control
{
    ...
    public class ProfileManager
    {
        ...
        private void CreateDummyDownloadMaps()
        {
            ...
            dartsCallerDownloadUrl = dartsCallerDownloadMap.GetDownloadUrlByOs("b3.0.1.2");
            ...
            dartsWledDownloadUrl = dartsWledDownloadMap.GetDownloadUrlByOs("b2.0.1.3");
            ...
            dartsPixelitDownloadUrl = dartsPixelitDownloadMap.GetDownloadUrlByOs("b2.0.1.3");
            ...
            dartsGifDownloadUrl = dartsGifDownloadMap.GetDownloadUrlByOs("b2.0.1.3");
        ...
        private async void CreateDummyAppsDownloadable()
        {
            ...
            if (!string.IsNullOrEmpty(dartsWledDownloadUrl))
            {
                ...
                var dartsWledArguments = new List<Argument> {
                        ...
                        new(name: "IDE", type: "string", required: false, isMulti: true, nameHuman: "-IDE / --idle_effect", section: "Idle Effects"),
                        new(name: "IDE2", type: "string", required: false, isMulti: true, nameHuman: "-IDE2 / --idle_effect_player2", section: "Idle Effects"),
                        new(name: "IDE3", type: "string", required: false, isMulti: true, nameHuman: "-IDE3 / --idle_effect_player3", section: "Idle Effects"),
                        new(name: "IDE4", type: "string", required: false, isMulti: true, nameHuman: "-IDE4 / --idle_effect_player4", section: "Idle Effects"),
                        new(name: "IDE5", type: "string", required: false, isMulti: true, nameHuman: "-IDE5 / --idle_effect_player5", section: "Idle Effects"),
                        new(name: "IDE6", type: "string", required: false, isMulti: true, nameHuman: "-IDE6 / --idle_effect_player6", section: "Idle Effects"),
                ...
                for (int i = 1; i <= 20; i++)
                {
                    ...
                    Argument dartscoreArgument = new(name: "DS" + dartscore, type: "string", required: false, isMulti: true, nameHuman: "-DS" + dartscore + " / --dart_score_" + dartscore + "_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read");
        ...
        private async void MigrateAppsDownloadable()
        {
            ...
            if (dartsWled != null)
            {
                if (dartsWledDownloadUrl != null)
                {
                    ...
                    if (wledds1 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS1", type: "string", required: false, isMulti: true, nameHuman: "-DS1 / --dart_score_1_effects", section: "Single Dart Effects!! still in Progress!!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds2 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS2");
                    if (wledds2 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS2", type: "string", required: false, isMulti: true, nameHuman: "-DS2 / --dart_score_2_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds3 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS3");
                    if (wledds3 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS3", type: "string", required: false, isMulti: true, nameHuman: "-DS3 / --dart_score_3_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds4 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS4");
                    if (wledds4 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS4", type: "string", required: false, isMulti: true, nameHuman: "-DS4 / --dart_score_4_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds5 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS5");
                    if (wledds5 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS5", type: "string", required: false, isMulti: true, nameHuman: "-DS5 / --dart_score_5_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds6 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS6");
                    if (wledds6 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS6", type: "string", required: false, isMulti: true, nameHuman: "-DS6 / --dart_score_6_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds7 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS7");
                    if (wledds7 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS7", type: "string", required: false, isMulti: true, nameHuman: "-DS7 / --dart_score_7_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds8 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS8");
                    if (wledds8 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS8", type: "string", required: false, isMulti: true, nameHuman: "-DS8 / --dart_score_8_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds9 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS9");
                    if (wledds9 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS9", type: "string", required: false, isMulti: true, nameHuman: "-DS9 / --dart_score_9_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds10 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS10");
                    if (wledds10 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS10", type: "string", required: false, isMulti: true, nameHuman: "-DS10 / --dart_score_10_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds11 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS11");
                    if (wledds11 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS11", type: "string", required: false, isMulti: true, nameHuman: "-DS11 / --dart_score_11_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds12 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS12");
                    if (wledds12 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS12", type: "string", required: false, isMulti: true, nameHuman: "-DS12 / --dart_score_12_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds13 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS13");
                    if (wledds13 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS13", type: "string", required: false, isMulti: true, nameHuman: "-DS13 / --dart_score_13_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds14 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS14");
                    if (wledds14 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS14", type: "string", required: false, isMulti: true, nameHuman: "-DS14 / --dart_score_14_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds15 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS15");
                    if (wledds15 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS15", type: "string", required: false, isMulti: true, nameHuman: "-DS15 / --dart_score_15_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds16 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS16");
                    if (wledds16 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS16", type: "string", required: false, isMulti: true, nameHuman: "-DS16 / --dart_score_16_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds17 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS17");
                    if (wledds17 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS17", type: "string", required: false, isMulti: true, nameHuman: "-DS17 / --dart_score_17_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds18 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS18");
                    if (wledds18 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS18", type: "string", required: false, isMulti: true, nameHuman: "-DS18 / --dart_score_18_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds19 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS19");
                    if (wledds19 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS19", type: "string", required: false, isMulti: true, nameHuman: "-DS19 / --dart_score_19_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledds20 = dartsWled.Configuration.Arguments.Find(a => a.Name == "DS20");
                    if (wledds20 == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DS20", type: "string", required: false, isMulti: true, nameHuman: "-DS20 / --dart_score_20_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    var wledDSbull = dartsWled.Configuration.Arguments.Find(a => a.Name == "DSBULL");
                    if (wledDSbull == null)
                    {
                        dartsWled.Configuration.Arguments.Add(new(name: "DSBULL", type: "string", required: false, isMulti: true, nameHuman: "-DSBULL / --dart_score_BULL_effects", section: "Single Dart Effects !! still in Progress !!", requiredFeature: "i_m_able_to_read"));
                    }
                    ...
                    for (int i = 1; i <= 20; i++)
                    {
                        ...
                        if (WLEDDescMig != null) { WLEDDescMig.Description = "NOT FULLY IMPLEMENTED!!!!!!";
                            ...
                            WLEDDescMig.RequiredFeature = "i_m_able_to_read";
                        }
                    }
                    ...
                    if (IDEWLEDMig != null) { IDEWLEDMig.Section = "Idle Effects"; IDEWLEDMig.IsMulti = true; }
                    var IDE2WLEDMig = dartsWled.Configuration.Arguments.Find(a => a.Name == "IDE2");
                    if (IDE2WLEDMig != null) { IDE2WLEDMig.Section = "Idle Effects"; IDE2WLEDMig.IsMulti = true; }
                    var IDE3WLEDMig = dartsWled.Configuration.Arguments.Find(a => a.Name == "IDE3");
                    if (IDE3WLEDMig != null) { IDE3WLEDMig.Section = "Idle Effects"; IDE3WLEDMig.IsMulti = true; }
                    var IDE4WLEDMig = dartsWled.Configuration.Arguments.Find(a => a.Name == "IDE4");
                    if (IDE4WLEDMig != null) { IDE4WLEDMig.Section = "Idle Effects"; IDE4WLEDMig.IsMulti = true; }
                    var IDE5WLEDMig = dartsWled.Configuration.Arguments.Find(a => a.Name == "IDE5");
                    if (IDE5WLEDMig != null) { IDE5WLEDMig.Section = "Idle Effects"; IDE5WLEDMig.IsMulti = true; }
