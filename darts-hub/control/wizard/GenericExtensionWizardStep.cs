    ...
    public class GenericExtensionWizardStep : IWizardStep
    {
        ...
        private Control CreateNumericUpDown(Argument argument, bool isFloat)
        {
            ...
            if (ArgumentTypeHelper.TryGetNumericRange(argument, out var minimum, out var maximum))
            {
                ...
                System.Diagnostics.Debug.WriteLine($"[GenericWizard] Applied type-based range constraints to {argument.Name}: Min={minimum}, Max={maximum}");
            }
            else
            {
        ...
        /// </summary>
        private void SetNamedParameterLimits(NumericUpDown control, Argument argument, bool isFloat)
        {
            var argName = argument.Name.ToLower();
            ...
            switch (argName)
            {
                ...
                default:
                    ...
                    System.Diagnostics.Debug.WriteLine($"[GenericWizard] Using default positive range for {argument.Name}: Min={control.Minimum}, Max={control.Maximum}");
                    break;
            }
        }
