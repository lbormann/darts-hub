...
{
    /// <summary>
    /// Color definitions and parsing utilities for WLED effects
    /// </summary>
    public static class WledColorDefinitions
    {
        /// <summary>
        ...
        public static (int r, int g, int b) ParseColorEffect(string colorEffect)
        {
