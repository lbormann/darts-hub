...
namespace darts_hub.control
{
    ...
    public class NewSettingsContentProvider
    {
        ...
        private static Control? CreateParameterInputControl(Argument param, Action? saveCallback = null, AppBase? app = null)
        {
            ...
            switch (type)
            {
                ...
                case Argument.TypePassword:
                    ...
                    {
                        return CreateAdvancedEffectParameterControl(param, saveCallback, app);
                    }
                    else
                    {
        ...
        private static Control CreateAdvancedEffectParameterControl(Argument param, Action? saveCallback = null, AppBase? app = null)
        {
            var mainPanel = new StackPanel
            {
                Spacing = 8
