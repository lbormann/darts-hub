...
namespace darts_hub.control
{
    ...
    public class WledApi
    {
        ...
        private static (int r, int g, int b) ParseColorEffect(string colorEffect)
        {
            ...
            // Handle named colors - comprehensive color palette
            return colorEffect switch
            {
                // Basic colors
                "red" or "red1" => (255, 0, 0),
                "green" or "green1" => (0, 255, 0),
                "blue" or "blue1" => (0, 0, 255),
                "yellow" or "yellow1" => (255, 255, 0),
                "cyan" => (0, 255, 255),
                "magenta" => (255, 0, 255),
                "orange" or "orange1" => (255, 165, 0),
                "purple" or "purple1" => (155, 48, 255),
                "pink" or "pink1" => (255, 181, 197),
                "white" => (255, 255, 255),
                "black" => (0, 0, 0),
                "gray" => (128, 128, 128),
                ...
                // Additional common color aliases
                "fuchsia" => (255, 0, 255),
