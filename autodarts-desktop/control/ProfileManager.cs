...
namespace autodarts_desktop.control
{
    ...
    public class ProfileManager
    {
        ...
        private void CreateDummyAppsDownloadable()
        {
            ...
            var autodartsClientDownloadUrl = autodartsClientDownloadMap.GetDownloadUrlByOs("0.23.1");
            ...
            var autodartsCallerDownloadUrl = autodartsCallerDownloadMap.GetDownloadUrlByOs("2.8.4");
